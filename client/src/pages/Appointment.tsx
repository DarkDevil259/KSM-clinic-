        ...
        <div className="container-page py-8 md:py-12 px-4 sm:px-0">
          ...
          <Reveal delay={0.3}>
            <p className="mt-2 max-w-xl text-sm sm:text-base text-white/90">
              Schedule your visit in seconds — we'll confirm instantly
            </p>
          </Reveal>
        </div>
      </div>
      ...
      <div className="container-page py-8 sm:py-12 md:py-16 px-4 sm:px-0">
        <div className="grid gap-8 sm:gap-10 lg:grid-cols-2">
          <div>
            ...
            <Reveal delay={0.2}>
              <h1 className="mt-4 text-2xl sm:text-3xl font-black tracking-tight text-navy-900 md:text-4xl">
                Book an Appointment
              </h1>
            </Reveal>
            <Reveal delay={0.3}>
            ...
            <Reveal delay={0.4} width="100%">
              <div className="mt-6 sm:mt-8 rounded-[2rem] border border-slate-100 bg-gradient-to-br from-white via-white to-navy-50 p-4 sm:p-6 shadow-soft">
          ...
          <Reveal delay={0.2} width="100%">
            <div className="rounded-[2rem] border border-slate-100 bg-white p-4 sm:p-6 shadow-soft">
