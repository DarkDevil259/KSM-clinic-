...
const servicesData: Record<string, {
  ...
  "wisdom-tooth": {
    ...
    overview: "Wisdom tooth extraction is a dental procedure performed to remove the third molars (wisdom teeth) located at the back of the mouth. These teeth often do not erupt properly and may become impacted, causing pain, swelling, infection, and pressure on nearby teeth. Removing them early helps prevent complications and protects long-term oral health and comfort.",
    whatIs: {
      title: "What Is Wisdom Tooth Extraction?",
      content: "Wisdom tooth extraction involves removing one or more third molars that are partially erupted, fully impacted, or causing dental problems. Depending on the position of the tooth, the procedure may be simple (removal of a visible tooth) or surgical (requiring gum or bone access). The procedure is carried out under local anesthesia to ensure a comfortable, painless experience. After removal, gauze is placed to aid healing, and post-care instructions are provided to promote smooth recovery.",
    },
    whyNeeded: {
      title: "Why Choose Wisdom Tooth Extraction?",
      points: [
        "Relieves pain, swelling, and jaw discomfort",
        "Prevents infection, cyst formation, and gum inflammation",
        "Protects surrounding teeth from shifting or pressure",
        "Prevents decay in hard-to-reach areas of wisdom teeth",
        "Improves chewing comfort and oral hygiene",
    ...
    faq: [
      {
        ...
        answer: "Most patients recover in 2–4 days, although full healing of the gums may take 1–2 weeks.",
      },
      {
        question: "Is the procedure painful?",
        answer: "No — the tooth is removed under local anesthesia, making the process comfortable. Mild soreness afterward is normal and temporary.",
      },
      {
        question: "When should wisdom teeth be removed?",
        answer: "Extraction is recommended when there is pain, swelling, infection, food trapping, decay, or if X-rays show impaction that may cause future problems.",
      },
      {
        question: "Can I eat after the procedure?",
        answer: "Yes — begin with soft foods initially (yogurt, rice, juice, mashed foods). Avoid smoking, straw drinking, and hard foods for a few days to support healing.",
      },
    ],
  },
  "smile-design": {
